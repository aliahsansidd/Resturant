...
export class ProductCategoryComponent implements OnInit {
  ...
  Save() {
    ...
    if (this.ProductCategory.id > 0) {
      this.apiService.pharmacyService.updateProductCategory(this.ProductCategory).subscribe((res: any) => {
        this.ProductCategory.id = -1;
        this.GetAllProductCategory();
        this.myForm.resetForm();
      })
    } else {
      this.apiService.pharmacyService.SaveProductCategory(this.ProductCategory).subscribe((res: any) => {
        this.GetAllProductCategory();
        this.myForm.resetForm();
      })
    }
  ...
  EditRecord(id, $element: any) {
    let a = this.ProductCategoryCollection.find(x => x.id === id);
    this.ProductCategory.name = a.name;
    this.ProductCategory.shortName = a.shortName;
    this.ProductCategory.id = a.id;
  ...
  DeleteData(event) {
    ...
    this.apiService.pharmacyService.DeleteProductCategory(this.DeletedIndex).subscribe((res: any) => {
      this.GetAllProductCategory();
    });
  }
