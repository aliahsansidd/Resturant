import { Component, OnInit, Input, ChangeDetectorRef, OnChanges, SimpleChange, SimpleChanges, Output, EventEmitter } from '@angular/core';
import { ApiService } from 'app/Services/common/apiService';
import { BehaviorSubject } from 'rxjs';
declare var $;
import * as moment from 'moment';
import { ISelectionEvent } from '../../../../node_modules/ng2-date-picker';

@Component({
  selector: 'app-owl-date-picker',
  templateUrl: './owl-date-picker.component.html',
  styleUrls: ['./owl-date-picker.component.css']
})
export class OwlDatePickerComponent implements OnInit, OnChanges {
  // doctorDays: any;
  ISelectionEvent: any;
  selectedDates = [];
